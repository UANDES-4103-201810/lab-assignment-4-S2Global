...
place_1 = Place.create(name: 'Estadio Nacional de Chile', address:'Av. Grecia 2001', capacity: 50000)
place_2 = Place.create(name: 'Teatro Caupolican Central', address:'San Diego 850', capacity: 5000)
